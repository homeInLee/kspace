package com.kh.admin.banner.util;
...
public class BannerRenamePolicy implements FileRenamePolicy {
	...
	public File rename(File oldFile) {
		...
		do {
			...
			//새이름부여
			String newName 
				= sdf.format(new Date(currentTime))+"_"+rndNum+ext;
