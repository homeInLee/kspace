 ...
 * Generated at: 2019-08-14 11:57:23 UTC
...
public final class spaceFilter_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1565768344313L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <input type=\"text\" name=\"spaceSrch\" id=\"spaceSrch\" placeholder=\"지역 또는 공간유형을 검색해보세요!\" autocomplete=\"off\">\r\n");
	...
	List<SpaceImageFile> imageList = (List<SpaceImageFile>)request.getAttribute("imageList");
      ...
      out.write("<script>\r\n");
      out.write("$(()=> {\r\n");
      out.write("\t$(\"#spaceType-select .select-items\").click(function() {\r\n");
      out.write("\t\tvar spaceType = $(\"#spaceType-select option:selected\").val();\r\n");
      out.write("\t\tvar spaceArea = $(\"#spaceArea-select option:selected\").val();\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tlocation.href= \"");
      out.print(request.getContextPath());
      out.write("/search/spaceFinder?spaceType=\" + spaceType + \"");
if(spaceSrch!=null){
      out.write("&spaceSrch=");
      out.print(spaceSrch);
}
 ...
 if(spaceArea!=null) { 
      ...
      out.write("\t});\r\n");
      out.write("\r\n");
      out.write("\t$(\"#spaceArea-select .select-items\").click(function() {\r\n");
      out.write("\t\tvar spaceType = $(\"#spaceType-select option:selected\").val();\r\n");
      out.write("\t\tvar spaceArea = $(\"#spaceArea-select option:selected\").val();\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tlocation.href= \"");
      out.print(request.getContextPath());
      out.write("/search/spaceFinder?spaceArea=\" + spaceArea + \"");
if(spaceSrch!=null){
      out.write("&spaceSrch=");
      out.print(spaceSrch);
}
...
if(spaceType != null){
      ...
      out.write("                                <option value=\"스터디룸\" ");
      out.print(spaceType.equals("스터디룸")?"selected":"" );
      out.write(">스터디룸</option>\r\n");
      out.write("                                <option value=\"공연장\" ");
      out.print(spaceType.equals("공연장")?"selected":"" );
      out.write(">공연장</option>\r\n");
      out.write("                                <option value=\"세미나실\" ");
      out.print(spaceType.equals("세미나실")?"selected":"" );
      out.write(">세미나실</option>\r\n");
      out.write("                                <option value=\"파티룸\" ");
      out.print(spaceType.equals("파티룸")?"selected":"" );
      out.write(">파티룸</option>\r\n");
      out.write("                                <option value=\"카페\" ");
      out.print(spaceType.equals("카페")?"selected":"" );
      out.write(">카페</option>\r\n");
      out.write("                                <option value=\"기타\" ");
      out.print(spaceType.equals("기타")?"selected":"" );
      out.write(">기타</option>\r\n");
      out.write("                            </select>\r\n");
      out.write("                        </div>\r\n");
      out.write("                    </div>\r\n");
      ...
      out.print(spaceSrch);
      out.write("\" />\r\n");
      out.write("            <input type=\"hidden\" name=\"spaceType\" value=\"");
      out.print(spaceType);
      out.write("\" />\r\n");
      out.write("            <input type=\"hidden\" name=\"spaceArea\" value=\"");
      out.print(spaceArea);
      out.write("\" />\r\n");
...
if(!imageList.isEmpty()) { 
 ...
 for(SpaceImageFile i : imageList) { 
      ...
      out.print(i.getImageRenamedFileName() );
      out.write("\" alt=\"\" />\r\n");
      out.write("\t\t\t\t\t\t\t");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<img src=\"");
      out.print(request.getContextPath() );
      out.write("/images/example.jpeg\" alt=\"이미지영역\" class=\"dp_block\">\r\n");
      out.write("\t\t\t\t\t\t\t");
 }}} 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
